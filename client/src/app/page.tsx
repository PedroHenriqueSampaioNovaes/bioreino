...
export const metadata: Metadata = {
  title: 'Bioreino | Home',
  description: 'Página inicial da bioreino para apresentar a plataforma e a vantagem de cada plano de assinatura.',
};

export default async function HomePage() {
  const { data: courses } = await getCourses({ free: true, limit: 3 });
